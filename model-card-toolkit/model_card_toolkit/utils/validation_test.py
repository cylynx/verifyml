...
_MODEL_DETAILS_V1_DICT = {
    "name": "my model",
    "owners": [
        {"name": "foo", "contact": "foo@xyz.com"},
        {"name": "bar", "contact": "bar@xyz.com"},
    ],
    "version": {"name": "0.01", "date": "2020-01-01"},
    "license": "Apache 2.0",
...
_MODEL_PARAMETERS_V1_DICT = {
    ...
    "data": {
        "train": {
            ...
            "link": "path/to/train",
            "sensitive": True,
            "graphics": {"collection": [{"name": "image1", "image": "rawbytes"}]},
        },
        "eval": {"name": "eval_split", "link": "path/to/eval"},
    },
}
_QUANTITATIVE_ANALYSIS_DICT = {
    "graphics": {"collection": [{"name": "image1", "image": "rawbytes"}]},
    "performance_metrics": [{"type": "log_loss", "value": 0.2}],
}
_CONSIDERATIONS_V1_DICT = {
    ...
    "ethical_considerations": [{"name": "risk1", "mitigation_strategy": "a solution"}],
}
_MODEL_CARD_V1_DICT = {
...
_MODEL_DETAILS_V2_DICT = {
    ...
    "references": [{"reference": "https://my_model.xyz.com"}],
    "citation": {"citation": "https://doi.org/foo/bar"},
}
_MODEL_PARAMETERS_V2_DICT = {
    ...
    "data": [
        ...
        {"name": "eval_split", "link": "path/to/eval"},
    ],
}
_CONSIDERATIONS_V2_DICT = {
    "users": [{"description": "foo"}, {"description": "bar"}],
    "use_cases": [{"description": "use case 1"}],
    "limitations": [{"description": "a limitation"}],
    "tradeoffs": [{"description": "tradeoff 1"}],
    "ethical_considerations": [{"name": "risk1", "mitigation_strategy": "a solution"}],
}
_MODEL_CARD_V2_DICT = {
...
class ValidationTest(parameterized.TestCase):
    def test_validate_json_schema(self):
        validation.validate_json_schema(_MODEL_CARD_V1_DICT, schema_version="0.0.1")
    ...
    def test_template_test_files(self, file_name):
        ...
        json_data = json.loads(pkgutil.get_data("model_card_toolkit", template_path))
