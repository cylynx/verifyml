        ...
        for field_name, field_value in self.__dict__.items():
            ...
            if field_descriptor.type == descriptor.FieldDescriptor.TYPE_MESSAGE:
                if field_descriptor.label == descriptor.FieldDescriptor.LABEL_REPEATED:
                    ...
                    getattr(proto, field_name).CopyFrom(
                        field_value.to_proto()
                    )  # pylint: disable=protected-access
            ...
            if field_descriptor.type == descriptor.FieldDescriptor.TYPE_MESSAGE:
                if field_descriptor.label == descriptor.FieldDescriptor.LABEL_REPEATED:
                    ...
                    for p in getattr(proto, field_name):
                        ...
                        field = self.__annotations__[field_name].__args__[
                            0
                    ...
                    getattr(self, field_name)._from_proto(
                        getattr(proto, field_name)
                    )  # pylint: disable=protected-access
