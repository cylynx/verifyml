...
class ModelCardToolkitTest(absltest.TestCase):
    def setUp(self):
        ...
        self.tmpdir = os.path.join(
            absltest.get_default_test_tmpdir(), f"model_card_{uuid.uuid4()}"
        )
    ...
    def test_scaffold_assets(self):
        ...
        self.assertIn("model_card.proto", os.listdir(os.path.join(output_dir, "data")))
    ...
    def test_export_format_with_customized_template_and_output_name(self):
        ...
        result = mct.export_format(template_path=template_path, output_file=output_file)
