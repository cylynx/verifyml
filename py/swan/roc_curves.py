...
def roc_curve_groups_test(
    ...
    for i in df_test_with_output[attr].unique():
        ...
        plt.scatter(
            ...
            marker=".",
            s=70,
            label=optimal_txt + " = " + str(optimal_threshold) + ", " + attr + "_" + i,
        )
        plt.scatter(
            fpr[idx],
            tpr[idx],
            ...
            marker="x",
            s=30,
            label=txt + " = " + str(threshold) + ", " + attr + "_" + i,
        )
    ...
    if metric == "tpr":
        plt.axhline(
            ...
            color="black",
            linestyle="--",
            label="Mininum TPR Threshold = " + str(metric_threshold),
        )
    elif metric == "fpr":
        plt.axvline(
            x=metric_threshold,
            color="black",
            linestyle="--",
            label="Maximum FPR Threshold = " + str(metric_threshold),
        )
